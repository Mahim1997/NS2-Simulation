...
printf("\nNow printing per node throughput in bits per second (ONLY THOSE WITH NON ZERO and NON INF VALUES)\n");
	for(i=0; i<maximumNodeNumber; i++){
		if(start_time_per_node[i] != 100000 && throughput_per_node_bits[i] > 0 && del_time[i] != 0){
