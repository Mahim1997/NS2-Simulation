...
#d 848.0000 14 -2 cbr 210 ------- 1 14.0 15.0 6 21 0.00 10.00 -999.00 -999.00		DROPPED
	...
	printf("INSIDE Satellite's AWK FILE!\n");
}
...
END {
	...
	deliveryRatio, dropRatio, errorRatio);
...
#################FILE PRINTING ##############
	...
	printf("%0.2f %0.2f\n", variable, total_throughput) >> "Throughput.txt";
	printf("%0.2f %0.2f\n", variable, dropRatio) >> "Drop_Ratio.txt";
	printf("%0.2f %0.2f\n", variable, deliveryRatio) >> "Delivery_Ratio.txt";
	printf("%0.2f %0.2f\n", variable, errorRatio) >> "Error_Ratio.txt";	
